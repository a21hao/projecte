...
public class VentanaCompra : MonoBehaviour
{
    ...
    public void Comprar()
    {
        ...
        if (emptySlot != null)
        {
            ...
            itemComponent.SetInformacion(objetoTienda.nombreText, objetoTienda.spriteImage, objetoTienda.precioObjeto, objetoTienda.descripcionObjeto, objetoTienda.id, objetoTienda.tipo, cantidad,objetoTienda.objeto3d);
