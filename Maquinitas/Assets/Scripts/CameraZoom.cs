...
public class CameraZoom : MonoBehaviour
{
    ...
    private CinemachineFreeLook freeLookCameraToZoom;
    public float zoomSpeed = 1f;
    public float zoomAcceleration = 2.5f;
    public float menorZoom;
    ...
    private void Awake()
    {
        ...
        freeLookCameraToZoom = GetComponent<CinemachineFreeLook>();
        currentMiddleRigRadius = 0;
        newMiddleRigRadius = 0;
        dirZoom = transform.forward.normalized;
        zoomInnerRange = - menorZoom;
        zoomOuterRange = maxZoom;
